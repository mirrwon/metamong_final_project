...
from cv_app.cv.cv_config import (
...
from cv_app.cv.camera_intrinsics import make_K_from_fov

print("[PIPELINE FILE]", __file__)

DATASET_71765_ROOT = os.environ.get("DATASET_71765_ROOT", "/data/71765_json")
ROOT = os.path.join(DATASET_71765_ROOT, "Training", "02.labeling", "3D 공간 모델")
